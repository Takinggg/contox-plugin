...
## Session End
When the user is done working or asks you to save, use `contox_save_session` to persist what was accomplished. Categorize changes into: architecture, conventions, implementation, decisions, bugs, todo.
